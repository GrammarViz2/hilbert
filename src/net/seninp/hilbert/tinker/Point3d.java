...
public class Point3d extends Tuple3d implements java.io.Serializable {
   ...
   * equal to: abs(x1-x2) + abs(y1-y2) + abs(z1-z2).
   * 
   * @param p1 the other point
  ...
  // /**
  // * Multiplies each of the x,y,z components of the Point4d parameter by 1/w and places the
  // * projected values into this point.
  // *
