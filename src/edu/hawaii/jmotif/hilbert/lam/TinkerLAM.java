package edu.hawaii.jmotif.hilbert.lam;
...
public class TinkerLAM {
  ...
  private final static double ZOOM_LEVEL = 14.;

  private static final int HILBERT_CURVE_LEVEL = 9;
  ...
  private static final String STATIC_MAP_FILENAME = "data/lam/lam-14_staticmap.png";

  // private static final String PATH_FILENAME = "data/castanet/11_2_2013_bike_hrm.csv";
  private static final String PATH_FILENAME = "data/lam/acid-walnut00_clean.csv";

  private static final String OUTPUT_PREFIX = "data/lam/acid-walnut00_2D";
  ...
  public static void main(String[] args) throws IOException {
    ...
    //
    Point2D.Double staticMapCenterLatLng = new Point2D.Double(35.891878, -106.306412);
    ...
    BufferedWriter bw = new BufferedWriter(
        new FileWriter(new File(OUTPUT_PREFIX + "_hilbert_curve.csv")));
  ...
  private static ArrayList<Point2D.Double> getRunningPath()
