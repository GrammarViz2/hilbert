package edu.hawaii.jmotif.hilbert.pau;
...
public class PauNormal {
  ...
  private static final String PATH_FILENAME = "data/TLS2Pau/transform2.csv";

  private static final String OUTPUT_PREFIX = "data/TLS2Pau/experiment/normal";
