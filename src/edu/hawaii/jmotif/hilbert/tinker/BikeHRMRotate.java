...
public class BikeHRMRotate {
  ...
  //
  // the Google static map used
  //
  // http://http://maps.googleapis.com/maps/api/staticmap?center=43.4485871277,1.5991950798&zoom=11&size=640x640&sensor=false
  ...
  private static final String OUT_PREFIX = "data/castanet/bike_hrm_2D_4";
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (Point2D.Double p : runningPath) {
      ...
      double x = yO;
      double y = HILBERT_CURVE_SIZE - xO;
